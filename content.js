FMATH.ApplicationConfiguration.setFolderUrlForFonts(chrome.extension.getURL('fonts'));
FMATH.ApplicationConfiguration.setFolderUrlForGlyphs(chrome.extension.getURL('glyphs'));
